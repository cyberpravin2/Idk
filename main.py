...
💡 *Note:* Only authorized users can access the bot. Contact @xtrytowon for authorization.
...
You are not authorized to use this bot. Please contact @xtrytowon for authorization.
        """
